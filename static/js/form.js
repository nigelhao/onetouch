...
//dropdown list
$('body').click(function() {
  if ($('.custom-select-form .drop-down-list').is(':visible')) {
    $('.custom-select-form').parent().removeClass('focus');
  }
  $('.custom-select-form .drop-down-list:visible').slideUp();
});
$('.custom-select-form .active-list').click(function() {
  $(this).parent().parent().addClass('focus');
  $(this).parent().find('.drop-down-list').stop(true, true).delay(10).slideToggle(300);
});
$('.custom-select-form .drop-down-list li').click(function() {
